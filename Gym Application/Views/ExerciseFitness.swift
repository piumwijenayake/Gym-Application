...
class ExerciseFitness: UITableViewCell {
...
//                
        ...
        NSLayoutConstraint.activate([
                   ...
                   subtitleLabel.trailingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 8),
...
//// Adjust the height of the image view as needed
    ...
    func configure(withData data: ExercisData) {
        
            titleLabel.text = data.name
            subtitleLabel.text = data.duration
